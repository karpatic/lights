...
# its antenna projects above y=3425; cable/input landings sit at the foot.
POSITIONS={
 'U_ESP':(4055.433,3455.5),'J_LED':(4024.5,3516),
 'J_5V_IN':(4076.5945,3541.811),
 'D_VBUS':(4078,3516),'F_VBUS':(4075.203,3528.543),
 'U_3V3':(4048,3492),'U_LEVEL':(4062,3498),
 'R_EN':(4072,3505),'C_EN':(4082,3505),'R_BOOT':(4038,3447),
 'R_LEVEL_PD':(4023.0,3490),'R_DATA':(4050.5,3506),'C_LEVEL':(4082,3496),
 'C_VBUS_IN':(4032.5,3492),'C_3V3_OUT1':(4082,3490),
...
ROTATIONS={'D_VBUS':90,'U_3V3':270,'F_VBUS':180,'R_BOOT':180,'R_LEVEL_PD':270,'R_DATA':180,'C_VBUS_IN':180}
...
def main():
 ...
 try:
  ...
  # pitch, with 2.20-mm pads and 1.20-mm finished holes.
  ...
  print(json.dumps({'placed':len(POSITIONS),'bottom_pogo_pads':len(TPS),'board_mm':[18,32],'input_pigtail_pads':inp,'led_pigtail_pads':actual,'antenna_overhang_mm':5.05},indent=2))
 finally:c.close()
